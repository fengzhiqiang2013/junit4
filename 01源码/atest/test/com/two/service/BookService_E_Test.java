...
@PrepareForTest({OrganizationUtil.class, FilesUtil.class, BookServiceImpl.class})
public class BookService_E_Test {
	@Test
	public void testSaveBook() throws Exception{
		...
		//执行
		String id = bookService.saveBook_E(book, authorId, files);
